...
// ─── FilterBar — search input + chained selects ─────────────────
function FilterBar({ filters, onChange, query, onQuery }) {
  return (
    <div className="gst-filters">
      <div className="gst-search">
        <input value={query || ''} onChange={e => onQuery(e.target.value)} placeholder="Buscar por ID, perfil ou equipe…" />
        <button>
...
Object.assign(window, {
  ...
  CoverageBar, Trend, Sparkline, FilterBar,
});
